...
help_text <- paste(
    c(
        ...
        "  test     - run tests (testthat::test_package)",
...
res <- switch(
    ...
    doc = {
        ...
        run_safe(function() roxygen2::roxygenise(pkg_dir()))
    },
    lint = {
    ...
    test = {
        install_if_missing(c("testthat"))
        run_safe(function() testthat::test_package(pkg_dir()))
    },
    check = {
